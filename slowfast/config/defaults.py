...
_C.TRAIN.CHECKPOINT_TYPE = "caffe2"
...
_C.DEMO.SLOWMO = 1
_C.DEMO.CSV_DIR_PATH = "res"
_C.DEMO.SPLIT_MAX_STRIDE = 2
_C.DEMO.OUTPUT_FILE_DIR = "split_res"
